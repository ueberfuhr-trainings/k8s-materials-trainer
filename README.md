...
| 11:00 – 12:00 | 60 min | Theorie + Praxis | **Was ist OpenShift?** — Unterschiede, SCCs, Routes; **Web Console live erkunden** — [Doku](https://ueberfuhr-trainings.github.io/k8s-materials/docs/openshift.html)<br>*Trainerhinweis: Zugriff per `oc`-CLI ausprobieren ([CLI Cheat Sheet](https://ueberfuhr-trainings.github.io/k8s-materials/docs/cli-cheatsheet.html))* |
| 12:00 – 13:00 | 60 min | Theorie + Demo   | **Kubernetes-Ressourcen (Teil 1)** — Pod, Deployment, ReplicaSet, Service — [Doku](https://ueberfuhr-trainings.github.io/k8s-materials/docs/kubernetes-resources.html). *Trainerhinweis: die Schritte aus Übung 1 gleich live vorführen*                                                                                      |
